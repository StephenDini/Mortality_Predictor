function init() {
  ...
  d3.json("cleaned_data/samples.json").then((data) => {
...
function buildCharts(sample) {
  // 2. Use d3.json to load and retrieve the cleaned_data/samples.json file
  d3.json("cleaned_data/samples.json").then((data) => {
    ...
    var yticks = top_otu_ids.map(ytick => "OTU " + ytick);
